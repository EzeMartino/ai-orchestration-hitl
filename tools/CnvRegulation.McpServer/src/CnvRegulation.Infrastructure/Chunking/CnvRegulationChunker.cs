...
/// <summary>
/// Splits CNV-like regulation documents into article-level chunks.
/// </summary>
public sealed class CnvRegulationChunker(LegalStructureDetector structureDetector) : IRegulationChunker
{
    /// <inheritdoc />
